...
const darkPalettes: Record<HomeModuleGemKind, GemPalette> = {
  ...
  compare: {
    ...
    floatBottom: '#332450',
    detail: '#b88fe8',
    surfaceStroke: 'rgba(233, 214, 255, 0.24)',
    surfaceFill: 'rgba(243, 228, 255, 0.14)',
    surfaceFillSoft: 'rgba(243, 228, 255, 0.18)',
    lineStrong: 'rgba(248, 238, 255, 0.82)',
    lineSoft: 'rgba(214, 184, 255, 0.56)',
    lineDim: 'rgba(155, 121, 255, 0.34)',
    supportStroke: 'rgba(174, 141, 242, 0.34)'
  },
  suggestion: {

...
const compareIdentity = computed<ComparisonIdentity | null>(() => {
    ...
    return buildCompareIdentity({
        ...
        videoPath:
            analysisStore.currentVideoPath || analysisStore.currentVideoAnalysis?.videoPath || "",
            ...
            <section class="compare-page__workbench">
                ...
                <div v-else class="compare-page__empty">
                    ...
                    <div class="compare-page__empty-copy">
                        <p class="compare-page__empty-title">
                            先完成一次姿势分析，再进入对比工作台
                        </p>
                    ...
                    <div class="compare-page__empty-actions">
                        ...
                        <Button
                            variant="outline"
                            class="compare-page__empty-action"
                            @click="goToTemplates"
                        >
                            先管理球星模板
                        </Button>
